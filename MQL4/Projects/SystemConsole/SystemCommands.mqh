...
void SystemCommands::SetCommand(string cmd) {
	...
	if (firstMatch >= 0)
	{
		...
		LogInfoMessageIfTrue(false, __FUNCTION__ + " 1. [many words] ctx: \"" + ctx + "\" innerCmd: \"" + innerCmd + "\" [oldCommand: \"" + oldCommand + "\", oldContext: \"" + oldContext + "\"] ");
	...
	{
		LogInfoMessageIfTrue(false, __FUNCTION__ + " 2. [one word] cmd: \"" + cmd + "\" [oldCommand: \"" + oldCommand + "\", oldContext: \"" + oldContext + "\"] ");
		command = cmd;
	}
}
...
string SystemCommands::UpdateContext(string value, bool changeContext = false)
{
	if (changeContext)
	{
		LogInfoMessageIfTrue(false, __FUNCTION__ + " context change \"" + context + "\" -> \"" + value + "\"");
		context = value;
	}
...
{
	LogInfoMessageIfTrue(false, __FUNCTION__ + " " + context);
...
{
	LogInfoMessageIfTrue(false, __FUNCTION__ + " [changeContext: " + BoolToString(changeContext) + "][context: \"" + context + "\", command: \"" + command + "\"]");
...
bool SystemCommands::NeedRefresh()
{
	...
	LogInfoMessageIfTrue(false, __FUNCTION__ + " <@return> [changeContext: " + BoolToString(changeContext) + "][context: \"" + context + "\", command: \"" + command + "\"] return: " + BoolToString(ret));
